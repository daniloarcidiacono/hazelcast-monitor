...
export class PageDashboardCachesComponent implements TabAwareComponent, OnDestroy {
  ...
  public navigateToCacheStats(row: CacheSummaryDTO): void {
  ...
  public beforeShow(): void {
    if (!this.dataSub) {
      ...
      this.dataSub = this.hazelcastService.subscribeToCaches(this.clustersService.getCurrentCluster().instanceName, parameters).subscribe(
