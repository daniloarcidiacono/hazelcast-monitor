...
import {CacheProductDTO} from '@shared/dto/topic-products-aliases.dto';
import {
...
export class PageDashboardCacheComponent implements TabAwareComponent, OnDestroy {
  ...
  public beforeShow(): void {
    if (!this.dataSub) {
      ...
      this.dataSub = this.hazelcastService.subscribeToCache(this.clustersService.getCurrentCluster().instanceName, this.cacheName, parameters).subscribe(
