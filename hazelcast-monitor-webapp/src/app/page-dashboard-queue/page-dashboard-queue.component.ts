...
import {QueueProductDTO} from '@shared/dto/topic-products-aliases.dto';
import {
...
export class PageDashboardQueueComponent implements TabAwareComponent, OnDestroy {
  ...
  public beforeShow(): void {
    if (!this.dataSub) {
      ...
      this.dataSub = this.hazelcastService.subscribeToQueue(this.clustersService.getCurrentCluster().instanceName, this.queueName, parameters).subscribe(
