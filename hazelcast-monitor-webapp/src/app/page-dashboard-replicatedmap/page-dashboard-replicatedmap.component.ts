...
import {ReplicatedMapProductDTO} from '@shared/dto/topic-products-aliases.dto';
import {
...
export class PageDashboardReplicatedMapComponent implements TabAwareComponent, OnDestroy {
  ...
  public beforeShow(): void {
    if (!this.dataSub) {
      ...
      this.dataSub = this.hazelcastService.subscribeToReplicatedMap(this.clustersService.getCurrentCluster().instanceName, this.mapName, parameters).subscribe(
