...
import {
  ...
  SubscriptionNoticeResponseDTO, UpdateSubscriptionRequestDTO,
...
export class PageDashboardListsComponent implements TabAwareComponent, OnDestroy {
  ...
  public beforeShow(): void {
    if (!this.dataSub) {
      ...
      this.dataSub = this.hazelcastService.subscribeToLists(this.clustersService.getCurrentCluster().instanceName, parameters).subscribe(
