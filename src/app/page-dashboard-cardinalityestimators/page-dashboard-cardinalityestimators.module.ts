...
import {PageDashboardCardinalityEstimatorsComponent} from './page-dashboard-cardinalityestimators.component';
...
export class PageDashboardCardinalityEstimatorsModule {
}
