...
import {SemaphoresProductDTO, SemaphoreSummaryDTO} from '@shared/dto/topic-products.dto';
...
export class PageDashboardSemaphoresComponent implements TabAwareComponent, OnDestroy {
  ...
  public beforeShow(): void {
    if (!this.dataSub) {
      this.dataSub = this.hazelcastService.subscribeToSemaphores(this.clustersService.getCurrentCluster().instanceName).subscribe(
